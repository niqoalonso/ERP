      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
            <div class="row">
              <div class="col-6">
                  <h4 class="card-title">Encabezado Comprobante</h4>
              </div>
              <div class="col-6 d-flex justify-content-end">
                <router-link to="../ingreso-comprobante">
      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
            <div class="row">
              <div class="col-6">
                  <h4 class="card-title">Nuevo Detalle Comprobrante</h4>
              </div>
