...
class DetalleDocumento extends Model
{
    ...
    protected $fillable = ['producto_id', 'descripcion_debito', 'centrocosto_id', 'cantidad', 'precio', 'descuento_porcentaje', 'precio_descuento', 'descripcion_adicional', 'info_id', 'total', 'sku'];
