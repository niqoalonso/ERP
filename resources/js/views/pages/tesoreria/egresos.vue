                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="mb-3">
                            ...
                            type="text"
                            class="form-control form-control-sm"
                            v-model="formAprobacion.monto"
                            >
                        </div> 
                    </div>
                    <div class="col-md-3" v-if="inputNotaCredito">
                        <div class="mb-3">
                            <label>Monto Nota Credito</label>
                            <input 
                            readonly
                            type="text"
                            class="form-control form-control-sm"
                            v-model="formAprobacion.monto_notacredito"
                            >
                        </div>
                    </div>
                    <div class="col-md-3" v-if="inputNotaCredito">
                        <div class="mb-3">
                            <label>Monto Nota Debito</label>
                            <input 
                            readonly
                            type="text"
                            class="form-control form-control-sm"
                            v-model="formAprobacion.monto_notadebito"
                            >
                        </div>
                    </div>
                    <div class="col-md-3" v-if="inputNotaCredito">
                        <div class="mb-3">
                            ...
                            type="text"
                            class="form-control form-control-sm"
                            v-model="formAprobacion.monto_pagar"
                            >
                        </div>
                    </div>
                </div>
