...
use App\Http\Controllers\ProductoSistemaController;
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::get('checkStockExistencia/{empresa}/{producto}/{encabezado}', [CompraController::class, 'checkStockExistencia']);
    ...
    Route::post('/crearComprobanteCompra', [CompraController::class, 'GenerarComprobanteCompra']);
    Route::post('/crearComprobanteDebitoCompra', [CompraController::class, 'GenerarComprobanteDebitoCompra']);
    
    //ExistenciaEmitir
    Route::get('checkNameTarjeta/{name}/{empresa}', [ExistenciaController::class, 'checkNameTarjeta']);
    ...
    Route::get('ObtenerComprobantes/{id}', [ComprobanteController::class, 'ObtenerComprobantes']);
    Route::post('storeAsiento', [ComprobanteController::class, 'store']);
    Route::get('/aprobarComprobante/{id}', [ComprobanteController::class, 'aprobarComprobante']);
    Route::delete('deleteComprobante/{id}', [ComprobanteController::class, 'deleteComprobante']);
    Route::post('/buscarComprobantes', [ComprobanteController::class, 'buscarComprobante']);
    ...
    Route::delete('deleteDetalle/{id}', [DetalleComprobanteController::class, 'deleteDetalle']);
    ...
    Route::get('verificarTieneNotaCredito/{encabezado}', [TesoreriaController::class, 'verificarTieneNotaCredito']);
